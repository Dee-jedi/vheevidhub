      ...
      >
        <div className="flex px-4 flex-row justify-between items-center w-full mb-12 sm:mb-16">
          ...
          <motion.div variants={fadeUpVariants} className="flex items-center gap-2 sm:gap-4">
            <a href="https://www.linkedin.com/company/vheevid-hub/" target="_blank" rel="noopener noreferrer" className="w-11 h-11 rounded-full bg-gray-50 flex items-center justify-center text-gray-500 hover:bg-[#D62500] hover:text-white transition-all shadow-sm group">
            ...
            <a href="https://www.facebook.com/vheevidhub" target="_blank" rel="noopener noreferrer" className="w-11 h-11 rounded-full bg-gray-50 flex items-center justify-center text-gray-500 hover:bg-[#D62500] hover:text-white transition-all shadow-sm group">
            ...
            <a href="https://www.instagram.com/vheevidhub?igsh=YTAzYzR2enFmY2hj" target="_blank" rel="noopener noreferrer" className="w-11 h-11 rounded-full bg-gray-50 flex items-center justify-center text-gray-500 hover:bg-[#D62500] hover:text-white transition-all shadow-sm group">
